...
class Classifier {
  ...
  Future<String> getPred(Uint8List imgAsList) async {
    ...
    print(output[0]);
    var resultado = ['Blusa', 'Calça', 'Colete', 'Vestido', 'Casaco', 'Sandália', 'Camisa', 'Tênis', 'Bolsa', 'Bota de Cano Longo'];

    print("Inference took ${resultado[digitPred]}");
    return resultado[digitPred];
  }
}
